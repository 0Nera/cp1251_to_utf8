// Используется: https://github.com/Iyamoto/iconv-lite
// gcc -finput-charset=UTF-8 -fexec-charset=cp1251 main.c && ./a.out
...
char *cp2utf(char *s, int len) {
	char *ns = malloc(sizeof(char) * len * 4);
...
int main( ) {
	...
	char *converted = cp2utf(input, len);
